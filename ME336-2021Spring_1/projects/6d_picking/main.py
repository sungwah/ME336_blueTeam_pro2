...
def detectObject(detector_algo: Yolo5, color, crop_bounding=[250, 550, 400, 1050]):
...
if __name__ == '__main__':
    ...
    while 1:
        ...
        ret, uv, cla, cfi = detectObject(object_detector, color, crop_bounding=[250, 550, 400, 1050])
        if not ret:
            continue
        ...
        # Todo: filter plane
        plane_model = [-0.01958358, 0.17905483, 0.62021648, -0.76347061]
        new_pc = []
